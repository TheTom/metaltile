...
using tA_t = metal::tensor<threadgroup {t}, metal::extents<int, 16, 8 >, metal::tensor_inline>;
using tB_t = metal::tensor<threadgroup {t}, metal::extents<int, 16, 32>, metal::tensor_inline>;
